<link rel="stylesheet" href="{{asset('access/css/register.css')}}">
        ...
        <div class="overlay">
            ...
            <div class="overlay-panel overlay-right">
                ...
                <button class="ghost" id="signUp">Sign Up</button>
                 <a href="/register"> <button class="ghost" id="signUp">Home Page</button></a> 
            </div>
        </div>
    </div>
</div>

<script src="{{asset('access/js/register.js')}}"></script>