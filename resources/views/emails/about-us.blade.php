          ...
          <div class="overlay pt-100 pb-100 ">
            <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-6 align-items-center space-y-4"">
                        <ul>
                            <h2 class="contact-title ">Our Service</h2>
                            <li class="contact-info text-white ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum modi voluptate nemo sint quos eos inventore deserunt iste accusantium. Ab?</li> <br>
                            <li  class="contact-info text-white space-y-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum modi voluptate nemo sint quos eos inventore deserunt iste accusantium. Ab?</li> <br>
                            <li  class="contact-info text-white space-y-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum modi voluptate nemo sint quos eos inventore deserunt iste accusantium. Ab?</li> <br>
                            <li class="contact-info text-white space-y-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum modi voluptate nemo sint quos eos inventore deserunt iste accusantium. Ab?</li>
